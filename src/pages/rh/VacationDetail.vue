          ...
          <div class="flex flex-col 3xl:w-1/2 sm:w-full gap-4 px-8 py-4">
            ...
            <div v-if="vacation_requests.type_of_vacation == 'INT'" class="flex flex-col gap-4">
              ...
              <div class="flex flex-col">
                <label class="flex rounded-md mb-4 font-bold px-2 py-2 text-green-600" for="">Início: {{
            ...
            <div v-else-if="vacation_requests.type_of_vacation == 'VEN'" class="flex flex-col gap-4">
              ...
              <div class="flex items-center border-b-2 border-gray-100 focus-within:border-gray-600"></div>
              <div class="flex justify-between">
                <label class="flex w-full rounded-md mb-4 font-bold px-2 py-2 text-green-600" for="">Início venda: {{
            ...
            <div v-else-if="vacation_requests.type_of_vacation == 'PAR'" class="flex flex-col gap-4">
              ...
              <!-- 1º Intervalo -->
              <div class="flex">
                <label class="flex rounded-md mb-4 font-bold px-2 py-2 text-green-600" for="">1º Início: {{
                  vacation_requests.breaks_initial[0] }}</label>
                <div class="flex items-center border-b-2 border-gray-100 focus-within:border-gray-600"></div>
              ...
              <!-- 2º Intervalo -->
              <div class="flex">
                <label class="flex rounded-md mb-4 font-bold px-2 py-2 text-green-600" for="">2º Início: {{
              ...
              <!-- 3º Intervalo -->
              <div class="flex">
                <label class="flex rounded-md mb-4 font-bold px-2 py-2 text-green-600" for="">3º Início: {{
